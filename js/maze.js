...
function(r) {
	...
	const t=r.length,
        ...
        let R=new z("#000000",1.5,"1.0"), U=new z(randomcolor,8,"1.0"), k=new z(randomcolor,5,"0.1");
    ...
    init = ()=>{
        ...
        null===t && (t = "intermedio"), r.searchParams.set("nivel", t), window.history.replaceState(null, "Maze", r.href);
