...
function(r) {
   ...
   LEVELS={
	...
	alert('Para una mejor experiencia usa auricuales: la música de fondo esta acompañada por una fuente de sonido diferente en cada auricular que estimula las ondas ALFA (Terapia Binaural)');
	draw_maze(l)
