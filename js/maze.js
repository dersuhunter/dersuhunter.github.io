...
function(r) {
   ...
   LEVELS={
	basico:{W: alpha ? 22 : 15,H: alpha ? 15 : 22},
        intermedio:{W: alpha ? 42 : 30,H: alpha ? 30 : 42},
        avanzado:{W: alpha ? 52 : 40,H: alpha ? 40 : 52},
        locura:{W: alpha ? 62 : 50,H: alpha ? 50 : 62},
	mitico:{W: alpha ? 102 : 70,H: alpha ? 70 : 102}
    },
    draw_maze=r=>{
	const t=r.length,
		e=r[0].length,
